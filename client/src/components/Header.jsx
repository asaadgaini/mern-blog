...
function Header() {
  ...
  return (
    <Navbar className=' border-b-2'>
        ...
        <form>
            <TextInput type='text ' className='hidden lg:inline' rightIcon={AiOutlineSearch} placeholder='search'/>

            
        </form>
        <Button className='w-12 h-10 ' pill color={"gray"}> <AiOutlineSearch/> </Button>
